...
A comprehensive website and mobile application designed to address these challenges.
Provides an efficient and user-friendly platform that enhances the learning experience and streamlines academic processes.

<img width="302" height="203" alt="logo_image" src="https://github.com/user-attachments/assets/f3adcd43-89a2-4480-80fd-319ea7269532" />


## -Introduction
In the ever-evolving landscape of education, the  demand for an advanced, accessible, and efficient  learning management system is paramount.
EduConnect aims to bridge the gap between  traditional classroom settings and modern  technological advancements.
It provides a seamless and integrated  environment for both educators and students.
...
## -System Objectives
Develop an intuitive and user-friendly interfaceresembling a physical classroom.
Display enrolled subjects on the home page for  each student.
Provide full course content (PDFs, videos) in theCourses tab.
Offer access to all course materials for all four  years in the Resources tab.
Implement an AI-powered chatbot for student  support.
